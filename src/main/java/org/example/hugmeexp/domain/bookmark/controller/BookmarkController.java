...
public class BookmarkController {
    ...
    public ResponseEntity<ApiResponse<List<BookmarkResponse>>> getBookmarks(
        ...
        ApiResponse<List<BookmarkResponse>> res = ApiResponse.success("Bookmark status retrieved successfully", data);
    ...
    public ResponseEntity<ApiResponse<Void>> createBookmark(
        ...
        ApiResponse<Void> res = ApiResponse.success("북마크를 추가했습니다.");
        return ResponseEntity.ok(res);
    }

    @Operation(summary = "북마크 수정", description = "북마크 정보(이름, URL) 수정")
    @io.swagger.v3.oas.annotations.responses.ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "북마크 수정 성공"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "잘못된 요청"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "인증 실패"),
    ...
    public ResponseEntity<ApiResponse<Void>> updateBookmark(
        ...
        ApiResponse<Void> res = ApiResponse.success("북마크를 수정했습니다.");
        return ResponseEntity.ok(res);
    }

    @Operation(summary = "북마크 삭제", description = "특정 북마크 삭제")
    @io.swagger.v3.oas.annotations.responses.ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "북마크 삭제 성공"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "인증 실패"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "북마크 없음"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "500", description = "서버 오류")
    })
    ...
    public ResponseEntity<ApiResponse<Void>> deleteBookmark(
        ...
        ApiResponse<Void> res = ApiResponse.success("북마크를 삭제했습니다.");
        return ResponseEntity.ok(res);
    }
}