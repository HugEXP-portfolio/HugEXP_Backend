...
@NoArgsConstructor
@Builder
public class CommentEmojiReactionResponse {

    private Long id;    // PK

    private Long commentId;    // 댓글 반응일 경우에만 값 존재

    private ReactionUser reactorName;    // 반응한 사람 이름
    private String emoji;    // 이모지 값
    private LocalDateTime createdAt;    // 반응한 시간

    public static CommentEmojiReactionResponse from(CommentEmojiReaction reaction){
